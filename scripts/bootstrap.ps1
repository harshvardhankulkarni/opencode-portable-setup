...
# Usage: irm https://raw.githubusercontent.com/<YOU>/opencode-portable-setup/main/scripts/bootstrap.ps1 | iex
param([string]$RepoUrl = "https://github.com/<YOU>/opencode-portable-setup.git", [string]$Dest = "$env:USERPROFILE\opencode-portable-setup")
